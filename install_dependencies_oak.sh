...
# Packages for all Linux-based systems (including Raspberry Pi OS)
readonly linux_pkgs=(
    python3
    python3-pip
    udev
    #cmake  # pre-built binaries will be used
    git
    #python3-numpy  # will be installed via pip
)
...
readonly debian_arm_pkgs=(
    ${linux_pkgs[@]}
    # https://docs.opencv.org/master/d7/d9f/tutorial_linux_install.html
    # pre-built binaries will be used
    #build-essential
    #libgtk2.0-dev
    #pkg-config
    #libavcodec-dev
    ...
    libsm6
    libxext6
    # Don't install Qt5 + dependencies by default
    #python3-pyqt5
    #python3-pyqt5.qtquick
    #qml-module-qtquick-controls2
    #qml-module-qt-labs-platform
    ...
    # Required for OpenCV-based frame streaming
    libgtk-3-0
)

# Packages for RPi OS Bullseye
readonly debian_pkgs_pre22_04=(
    #libdc1394-22-dev  # pre-built binaries will be used
    libgl1-mesa-glx
    libtbb2
)

# Packages for RPi OS Bookworm
readonly debian_pkgs_post22_04=(
    #libdc1394-dev  # pre-built binaries will be used
    libgl1-mesa-glx
    libtbbmalloc2
)
